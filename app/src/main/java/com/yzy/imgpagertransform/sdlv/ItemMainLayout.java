package com.yzy.imgpagertransform.sdlv;
    ...
    protected void handleMotionEvent(MotionEvent ev, final float xDown, final float yDown, final int leftDistance) {
        ...
        switch (ev.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_MOVE:
                ...
                if (mScrollState == ItemMainLayout.SCROLL_STATE_CLOSE && Math.abs(ev.getX() - xDown) > mBtnRightTotalWidth*2) {
                    break;
                }
                ...
                if (fingerNotMove(ev, xDown, yDown) && !mIsMoving) {//手指的范围在50以内
                    ...
                    switch (mIntention) {
                        ...
                        case INTENTION_LEFT_ALREADY_OPEN:
                            ...
                            if(mScrollState == SCROLL_STATE_OPEN){//如果已经滑出，不能再向左滑
                                break;
                            }
                        ...
                        case INTENTION_RIGHT_ALREADY_OPEN:
                            ...
                            if(mScrollState == SCROLL_STATE_OPEN){//如果已经滑出，不能再向右滑
                                break;
                            }
